...
<table>
  ...
  <tr>
    <td>
      <img src="logbook/ProjectArtify/ProjectArtify/left.png" width="100%" alt="Left Panel">
    </td>
    <td>
  ...
  <tr>
    <td>
      <img src="logbook/ProjectArtify/ProjectArtify/centre.png" width="100%" alt="Centre Panel">
    </td>
    <td>
  ...
  <tr>
    <td>
      <img src="logbook/ProjectArtify/ProjectArtify/right.png" width="100%" alt="Right Panel">
    </td>
    <td>
...
**Left panel — Controls**
- Input source selection (webcam or image upload)
- Painting style selector
- Brush Intensity and Colour Boost sliders
- START / STOP buttons

**Centre panel — Canvas**
- Left canvas: original image or live camera feed
- Right canvas: artistic output / painting animation

**Right panel — Info & Export**
- Live stats (mode, style, FPS, resolution)
- Save Image and Save Timelapse buttons
- Tips
